...
### 🤖 AI 객체 추적
- YOLO 객체 인식 기반 사람 탐지
- ByteTrack으로 인물 ID 유지: 칼만 이동 예측과 고·저신뢰 검출의 2단계 연결
- 짧은 미검출 구간은 선택 인물만 최대 250ms 예측, ID 재획득은 최대 3초 유지
- 3초 미만의 소실 후 마지막 관측 위치 부근으로 재등장하면 겹침·크기·모호성 조건을 확인해 기존 ID 복구
